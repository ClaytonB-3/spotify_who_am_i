...
## Project Summary
1. Requested listening history from Spotify for the last year.
2. Leveraged Spotify API to request additional attributes on each song (e.g. danceability) and the artist (e.g. popularity and genres).
